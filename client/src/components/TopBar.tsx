    ...
    <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center justify-between gap-4 border-b border-border bg-background/90 px-4 backdrop-blur-md md:h-16 md:px-8">
      <div className="relative max-w-xl flex-1">
        ...
        <input
          ...
          className="h-10 w-full rounded-lg border border-border bg-surface-lighter py-2 pl-10 pr-4 text-sm text-white placeholder:text-secondary/80 outline-none transition-colors focus:border-primary focus:ring-2 focus:ring-primary/25"
          autoComplete="off"
        />
      </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <button
          type="button"
          className="relative rounded-lg p-2 text-secondary transition-colors hover:bg-white/[0.06] hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        ...
        <Link
          to="/profile"
          className="flex items-center gap-2 rounded-xl py-1.5 pl-1.5 pr-2 transition-colors hover:bg-white/[0.06] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 md:gap-3 md:pr-3"
        >
          ...
          <span className="hidden text-left sm:block">
            <span className="block text-sm font-semibold text-white">{user?.username ?? 'User'}</span>
